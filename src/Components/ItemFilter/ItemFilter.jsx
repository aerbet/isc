...
const ItemFilter = (props) => {
  const buttonsData = [
    ...
    {name: 'трансмиттер мутности', label: 'Трансмиттер мутности'},
    {name: 'компактный трансмиттер', label: 'Компактный трансмиттер'},
    {name: 'измеритель кислорода', label: 'Измеритель кислорода'},
    
    {name: 'трансмиттер M400G 2XH', label: 'Трансмиттер M400G 2XH'},
    {name: 'поточный анализатор TOC', label: 'Поточный анализатор'},
